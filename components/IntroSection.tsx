...
const FlowLineIcon = () => (
    <svg width="100%" height="100" viewBox="0 0 1200 100" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" className="absolute bottom-0 left-0 w-full h-auto -z-10">
        <defs>
        ...
        <path d="M0 50 Q 300 0, 600 50 T 1200 50" stroke="url(#flowGradient)" strokeWidth="2" fill="none" />
        <path d="M0 60 Q 300 20, 600 60 T 1200 60" stroke="url(#flowGradient)" strokeWidth="1" strokeOpacity="0.5" fill="none" />
    </svg>
);
