...
const processSteps = [
  {
    number: '1',
    title: 'Análisis',
    description: 'Evaluación de procesos y detección de oportunidades de mejora.',
  },
  {
    number: '2',
    title: 'Implementación',
    description: 'Configuración y personalización de herramientas de IA.',
  },
  { number: '3', title: 'Formación', description: 'Capacitación práctica para adopción efectiva.' },
  {
    number: '4',
    title: 'Soporte',
    description: 'Acompañamiento 30 días para asegurar una transición estable.',
  },
];
...
const ProcessStep: React.FC<(typeof processSteps)[0]> = ({ number, title, description }) => (
  <div className="text-center relative group transition-all duration-300 hover:scale-105">
    <div className="relative inline-block">
      <div className="text-6xl font-bold text-cyan-400 mb-4 transition-transform duration-300 group-hover:scale-110">
        {number}
      </div>
  ...
  return (
    <section id="proceso" className="py-20 md:py-32">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-16 text-white [text-shadow:0_0_20px_theme(colors.cyan.400/0.5)]">
