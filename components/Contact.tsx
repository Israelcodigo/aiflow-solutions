  ...
  return (
    <section id="contacto" className="py-20 md:py-32">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12 text-white [text-shadow:0_0_20px_theme(colors.cyan.400/0.5)]">
          Empieza Hoy
        </h2>
        <div className="max-w-2xl mx-auto">
          <div className="glow-card">
            <form
              ...
              className="relative z-10 bg-[#0f1334] p-8 rounded-2xl border border-slate-700/50"
            >
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all"
                  />
                </div>
                <div>
                  <label
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/40 transform transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
