            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    <p className="text-xl text-slate-300 leading-relaxed mb-8">
                        No se trata de cambiar lo que haces, sino de <span className="text-cyan-400 font-semibold">cómo lo haces</span>. 
                        Optimizamos tu tiempo, automatizamos lo mecánico y te convertimos en supervisor de procesos inteligentes.
                    </p>
                    <div className="inline-block bg-gradient-to-r from-slate-800/80 to-slate-900/80 rounded-2xl p-6 border border-slate-700/50">
                        <p className="text-slate-400 text-sm leading-relaxed">
                            ...
                            <span className="text-white"> Tú te enfocas en lo que realmente importa:</span> supervisar, decidir y hacer crecer tu negocio.
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto mb-20">
                    <h3 className="text-2xl font-bold text-white mb-12 text-center">Resultados, no promesas</h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300">
                            <p className="text-slate-300 italic mb-6">
                                "La automatización del reporting nos ahorró 15 horas al mes. El equipo fue rápido, profesional y el ROI fue evidente desde el primer mes."
                            </p>
                        ...
                        {/* Caso cuantificado */}
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300">
                            <h4 className="font-bold text-xl text-white mb-4">Reducción del 90% en tiempo de facturación</h4>
                            <p className="text-slate-300 mb-6">
                                Para una consultora B2B, implementamos un flujo que extrae datos de múltiples fuentes, genera facturas y las envía para aprobación.
                            </p>
                ...
                <div className="max-w-6xl mx-auto mb-20">
                    <h3 className="text-2xl font-bold text-white mb-12 text-center">¿En qué va a cambiar tu día a día?</h3>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300">
                            ...
                            <div className="space-y-3 text-sm text-slate-300">
                                <div className="flex items-start gap-3">
                                    <span className="text-red-400 mt-1">•</span>
                                    <span className="line-through">Perder clientes que visitan tu web fuera de horario</span>
                                </div>
                                <div className="flex items-start gap-3">
                                    <span className="text-cyan-400 mt-1">•</span>
                                ...
                                <div className="flex items-start gap-3">
                                    <span className="text-red-400 mt-1">•</span>
                                    <span className="line-through">Responder las mismas preguntas básicas una y otra vez</span>
                                </div>
                                <div className="flex items-start gap-3">
                                    <span className="text-cyan-400 mt-1">•</span>
                        ...
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300">
                            ...
                            <div className="space-y-3 text-sm text-slate-300">
                                ...
                                <div className="flex items-start gap-3">
                                    <span className="text-red-400 mt-1">•</span>
                                    <span className="line-through">Clasificar y organizar documentos uno por uno</span>
                                </div>
                                <div className="flex items-start gap-3">
                                    <span className="text-cyan-400 mt-1">•</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-6 border border-slate-700/50">
                            ...
                            <p className="text-slate-300 text-sm leading-relaxed">
                                15+ años optimizando procesos empresariales. Ex-consultor en McKinsey, especialista en automatización con IA para PYMEs y startups.
                            </p>
                        </div>
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/80 rounded-2xl p-6 border border-slate-700/50">
                            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center mx-auto mb-4">
                            ...
                            <p className="text-slate-300 text-sm leading-relaxed">
                                Ingeniera de ML con experiencia en Google y Meta. Experta en integración de modelos de IA y arquitecturas escalables para empresas.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-8">
                        <span className="bg-slate-800/50 px-3 py-1 rounded-full text-xs text-slate-300 border border-slate-700/50">ChatGPT</span>
                        <span className="bg-slate-800/50 px-3 py-1 rounded-full text-xs text-slate-300 border border-slate-700/50">Claude AI</span>
                        <span className="bg-slate-800/50 px-3 py-1 rounded-full text-xs text-slate-300 border border-slate-700/50">Google Gemini</span>
                        <span className="bg-slate-800/50 px-3 py-1 rounded-full text-xs text-slate-300 border border-slate-700/50">Automatización</span>
                        <span className="bg-slate-800/50 px-3 py-1 rounded-full text-xs text-slate-300 border border-slate-700/50">Integración</span>
                    </div>
