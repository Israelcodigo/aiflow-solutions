        ...
        <div className="flex flex-col lg:flex-row items-center justify-between lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="animate-fade-in-down">
              <p className="text-cyan-400 font-semibold text-lg mb-2">Según Harvard Business Review</p>
              <h1 className="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                Aumenta la calidad de tu trabajo en un 40%
              </h1>
            </div>
            <div
            ...
            >
              <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto lg:mx-0 mb-8">
                La IA generativa ya no es el futuro, es la ventaja competitiva de hoy. Empresas como la tuya la están usando para entregar resultados más rápidos y de mayor calidad.
                <br /><span className="font-semibold text-white">Te ayudamos a implementar la estrategia y las herramientas correctas.</span>
              </p>
              <div className="flex gap-4 justify-center lg:justify-start flex-wrap">
                <a
                  href="#diagnostico"
                  className="px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/30 transform transition-all duration-300"
                >
                  Solicita tu Diagnóstico de Potencial IA
                </a>
                <a
                  href="#market-proof"
                  className="px-8 py-4 rounded-full font-bold text-cyan-400 border-2 border-cyan-400 hover:bg-cyan-400 hover:text-[#0a0e27] transform transition-all duration-300"
                >
