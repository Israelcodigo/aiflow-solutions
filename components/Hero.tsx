          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <p className="text-lg md:text-xl text-slate-300 max-w-xl mx-auto lg:mx-0 mb-8">
                Ayudamos a consultoras y agencias a automatizar procesos de facturación, reporting y
                gestión de clientes usando IA. Recupera tu tiempo para hacer crecer tu negocio, no
                para gestionarlo.
              </p>
