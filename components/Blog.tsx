...
const blogPosts = [
    {
        ...
        excerpt: "Descubre cómo implementar un chatbot eficaz que reduzca hasta un 60% los costes operativos mientras mejora la experiencia del usuario.",
        readTime: "5 min",
    ...
    },
    {
        ...
        excerpt: "Identifica procesos repetitivos en tu empresa y aprende a automatizarlos para ahorrar hasta 15 horas semanales de trabajo manual.",
        readTime: "4 min",
    ...
    },
    {
        ...
        excerpt: "Análisis detallado de cómo una cadena retail aumentó sus ventas un 40% mediante automatización de procesos con IA.",
        readTime: "6 min",
            ...
            <div className="container mx-auto px-6">
                <header className="text-center mb-16">
                    ...
                    <p className="text-lg max-w-3xl mx-auto leading-relaxed text-slate-400">
                        Artículos especializados sobre automatización de procesos, chatbots para ecommerce y casos de éxito en la implementación de IA empresarial.
                    </p>
                </header>
                    ...
                    {blogPosts.map((post) => (
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                <div className="text-cyan-400 p-2 bg-cyan-400/10 rounded-lg">
                                    {post.icon}
                                </div>
                                <div>
